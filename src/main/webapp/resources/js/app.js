document.addEventListener("DOMContentLoaded", function () {
    ...
    class FormSteps {
        ...
        updateForm() {
            ...
            document.getElementById('institution').innerHTML = `Dla ${institution}`
            document.getElementById('bags').innerHTML = `${quantity} worków z kategorii ${category}`
            document.getElementById('deliveryStreet').innerHTML = ` ${street}`
            ...
            document.getElementById('deliveryPickUpComment').innerHTML = `uwagi dla kuriera: ${pickUpComment}`
            document.getElementById('deliveryPhone').innerHTML = `tel. ${phone}`
        }
